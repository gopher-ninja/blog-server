...
// SetBlogId sets the "blogId" field.
func (m *BlogMutation) SetBlogId(u uuid.UUID) {
	m.blogId = &u
}

// BlogId returns the value of the "blogId" field in the mutation.
func (m *BlogMutation) BlogId() (r uuid.UUID, exists bool) {
	v := m.blogId
	if v == nil {
		return
	}
...
// OldBlogId returns the old "blogId" field's value of the Blog entity.
// If the Blog object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *BlogMutation) OldBlogId(ctx context.Context) (v uuid.UUID, err error) {
...
// ResetBlogId resets all changes to the "blogId" field.
func (m *BlogMutation) ResetBlogId() {
	m.blogId = nil
}

// SetBlogTitle sets the "blogTitle" field.
func (m *BlogMutation) SetBlogTitle(s string) {
	m.blogTitle = &s
}

// BlogTitle returns the value of the "blogTitle" field in the mutation.
func (m *BlogMutation) BlogTitle() (r string, exists bool) {
	v := m.blogTitle
	if v == nil {
		return
	}
...
// OldBlogTitle returns the old "blogTitle" field's value of the Blog entity.
// If the Blog object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *BlogMutation) OldBlogTitle(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *BlogMutation) ResetBlogTitle() {
	m.blogTitle = nil
}
...
func (m *BlogMutation) Fields() []string {
	...
	if m.blogId != nil {
		fields = append(fields, blog.FieldBlogId)
	}
	if m.blogTitle != nil {
		fields = append(fields, blog.FieldBlogTitle)
	}
